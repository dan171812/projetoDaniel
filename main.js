function getProjects() {
  const urlGitHub = "https://api.github.com/users/dan171812/repos"; // Inserir o nome de usuário do seu github
...
function showProjects(data) {
  ...
  data.forEach((repo) => {
    ...
    a.href = repo["https://github.com/dan171812?tab=repositories"]; // Link para o repositório no GitHub
    a.target = "_blank";
